...
class TestLazyIterable(TestCase):
    ...
    def test_lazyType(self):
        self.assertEqual(str(lazy.__lazyType__), str(LazyIterable[T]))

    @logTest
    def test_cachedType(self):
        self.assertEqual(str(lazy.__cachedType__), str(CachedIterable[T]))
...
class TestCachedIterables(TestCase):
    ...
    @logTest
    def test_lazyType(self):
        self.assertEqual(str(cached.__lazyType__), str(LazyIterable[T]))

    @logTest
    def test_cachedType(self):
        self.assertEqual(str(cached.__cachedType__), str(CachedIterable[T]))
